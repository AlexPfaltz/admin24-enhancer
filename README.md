...
- **Темы оформления** — 7 палитр из коробки: светлые, тёмные,
  ...
  (стоковая Admin24).
- **Окрашивание статусов** — карточки заявок и комментарии
  в детальной заявке получают тон, соответствующий семантике
  (новое, в работе, своё, чужое и т.п.), с учётом активной темы.
